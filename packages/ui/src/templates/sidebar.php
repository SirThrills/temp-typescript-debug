<div class="d-flex flex-column flex-shrink-0 bg-body-tertiary">
  <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
    <a href="#" class="d-block mt-1 px-1 pt-1 link-body-emphasis text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Bigpoint Discord Management">
