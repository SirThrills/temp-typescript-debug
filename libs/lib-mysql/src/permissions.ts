// import { DBClient, Permission, PermissionItem } from '../../types'
// export const permissionsDatabase = (dbClient: DBClient) => {
//     return {
//         async getPermissionsForGuild(
//             guildId: string
//         ): Promise<PermissionItem[] | undefined> {
//             const client = await dbClient.getConn()
